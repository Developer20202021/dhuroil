...
class OthersFeePay extends StatefulWidget {
...
class _OthersFeePayState extends State<OthersFeePay> {
  ...
  Future StudentOthersFeePayFunction(PaymentID, moneyReceiverEmail, moneyReceiverName) async{
    ...
    setState(() {
      loading = true;
          ...
          final docUser =  FirebaseFirestore.instance.collection("OthersFeePayPayHistory");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      systemOverlayStyle: SystemUiOverlayStyle(
        ...
        title: const Text("Others Fee",  style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17),),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    FirebaseAuth.instance
                      ...
                      StudentOthersFeePayFunction(PaymentID, user.email, user.displayName);
